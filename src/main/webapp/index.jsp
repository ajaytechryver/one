...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#coffee shop">Clothes</a></li>
    ...
    <main>
        <section id="phones" class="product-section">
            <h2>Smartphones</h2>
            <div class="product-grid" id="mobile-product"> <!-- Bug: ID should be 'phone-products' -->
                <!-- Phone products will be inserted here by JavaScript -->
            </div>
        </section>
